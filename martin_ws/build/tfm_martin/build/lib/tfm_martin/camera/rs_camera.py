...
class RealSenseCamera(object):
    def __init__(self, width=640, height=480, fps=30, serial_number=None):
        ...
        # --- Configuración por número de serie ---
        if serial_number is not None:
            self.config.enable_device(str(serial_number))
            print(f"[CÁMARA] Forzando inicialización de RealSense S/N: {serial_number}")
        else:
            print("[CÁMARA] Inicializando primera RealSense disponible.")
        # ------------------------------------------
