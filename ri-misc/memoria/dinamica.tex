...
El fabricante no aporta estos valores, pero se puede realizar una estimación teórica, 
...
Con todos estos parámetros definidos se implementa el código \ref{lst:din_control}, que 
